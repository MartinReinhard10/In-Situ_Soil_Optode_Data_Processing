...
move_distance_button = tk.Button(motor_control, text="Move to Distance", command=()).grid(row=7,column=0,padx=10,pady=10)
...
number_images_sequence.grid(row=4,column=0,padx=5,pady=5)
measurement_direction_vertical_label = tk.Label(mearsurement_frame, text="DOWN")
measurement_direction_vertical_label.grid(row=5,column=1,padx=5,pady=5)
measurement_direction_vertical_button = tk.Button(mearsurement_frame,text="Vertical Measurement Direction:", command=measurement_direction).grid(row=5,column=0,padx=5,pady=5)
start_measure_button = tk.Button(mearsurement_frame,text="Start Measurement Sequence").grid(row=6,column=0,padx=5,pady=5)
stop_measure_button = tk.Button(mearsurement_frame,text="Stop Measurement Sequence").grid(row=7,column=0,padx=5,pady=5)
